...
Export-PfxCertificate -Cert $rootCA -FilePath MediaInAction-root-cert.pfx -Password $password | Out-Null
...
Export-Certificate -Cert $rootCA -FilePath MediaInAction-root-cert.cer -Type CERT | Out-Null
