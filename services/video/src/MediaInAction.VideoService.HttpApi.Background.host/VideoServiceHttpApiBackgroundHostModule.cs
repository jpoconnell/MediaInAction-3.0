...
using MediaInAction.VideoService.BackgroundWorkers;
...
public class VideoServiceHttpApiBackgroundHostModule : AbpModule
{
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
      ...
      {
          endpoints.MapGrpcService<SeriesGrpcTestService>();
          endpoints.MapGrpcService<MovieGrpcTestService>();
          endpoints.MapGrpcService<EpisodeGrpcTestService>();
      });
    }
