...
[ExposeServices(typeof(ITraktMethod), typeof(CollectionTraktMethod))]
public class CollectionTraktMethod : ITraktMethod
{
    public string Name => TraktMethodNames.Collection;
