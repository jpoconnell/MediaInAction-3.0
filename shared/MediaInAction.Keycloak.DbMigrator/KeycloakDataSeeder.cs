...
public class KeyCloakDataSeeder : IDataSeedContributor, ITransientDependency
{
    ...
    {
        var cmsKitClient =
            (await _keycloakClient.GetClientsAsync(_keycloakOptions.RealmName, clientId: "MediaInAction_CmskitService"))
            .FirstOrDefault();
    ...
    private async Task CreateWebClientAsync()
    {
        ...
        if (webClient == null)
        {
            ...
            await AddOptionalClientScopesAsync(
                ...
                new List<string>
                {
                    "AdministrationService", "IdentityService", "EmbyService", "VideoService",
    ...
    private async Task CreateSwaggerClientAsync()
    {
        ...
        if (swaggerClient == null)
        {
            ...
            var orderingServiceRootUrl = _configuration[$"Clients:FileService:RootUrl"].TrimEnd('/');
            var paymentServiceRootUrl = _configuration[$"Clients:TraktService:RootUrl"].TrimEnd('/');
            ...
            swaggerClient = new Client
            {
                ...
                RedirectUris = new List<string>
                {
                    ...
                    $"{orderingServiceRootUrl}/swagger/oauth2-redirect.html", // FileService redirect uri
                    $"{paymentServiceRootUrl}/swagger/oauth2-redirect.html", // TraktService redirect uri
