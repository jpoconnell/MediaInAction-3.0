...
[DependsOn(
    ...
    typeof(EmbyServiceContractsModule),
...
public class MediaInActionPublicWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(MediaInActionResource),
                typeof(MediaInActionPublicWebModule).Assembly
            );
        });
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        ConfigureEmbyHttpClient(context);

        context.Services.AddAutoMapperObjectMapper<MediaInActionPublicWebModule>();
        Configure<AbpAutoMapperOptions>(options => { options.AddMaps<MediaInActionPublicWebModule>(validate: true); });
        ...
        Configure<AbpDistributedCacheOptions>(options => { options.KeyPrefix = "MediaInAction:"; });
        ...
        context.Services.AddAuthentication(options =>
            ...
            .AddAbpOpenIdConnect("oidc", options =>
            {
                ...
                options.Scope.Add("EmbyService");
                options.Scope.Add("IdentityService");
                options.Scope.Add("VideoService");
                options.Scope.Add("TraktService");
                options.Scope.Add("FileService");
        ...
        {
            options.MenuContributors.Add(new MediaInActionPublicWebMenuContributor(configuration));
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new MediaInActionPublicWebToolbarContributor());
        });
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseConfiguredEndpoints(endpoints =>
        {
            ...
            endpoints.MapForwarder("*/product-images/{name}", "http://_http.videoService/product-images", "/{name}");
            endpoints.MapForwarder("/products/product-images/{name}", "http://_http.videoService/product-images", "/{name}");
        });
    }

    private void ConfigureEmbyHttpClient(ServiceConfigurationContext context)
    {
        context.Services.AddStaticHttpClientProxies(
            typeof(EmbyServiceContractsModule).Assembly,
    ...
    {
        var logger = httpContext.RequestServices.GetRequiredService<ILogger<MediaInActionPublicWebModule>>();
