...
{
    public class MediaInActionPublicWebMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public MediaInActionPublicWebMenuContributor(IConfiguration configuration)
        {
        ...
        {
            var l = context.GetLocalizer<MediaInActionResource>();

            // Home
            context.Menu.AddItem(
                new ApplicationMenuItem(
                    MediaInActionPublicWebMenus.HomePage,
                    l["Menu:Home"],
                    "~/",
                    icon: "fa fa-home",
                    order: 0
        ...
        private Task ConfigureUserMenuAsync(MenuConfigurationContext context)
        {
            ...
            var eShopResource = context.GetLocalizer<MediaInActionResource>();
