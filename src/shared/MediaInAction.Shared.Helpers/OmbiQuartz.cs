...
{
    public class MediaInActionQuartz
    {
        ...
        // Singleton
        protected static MediaInActionQuartz _instance;

        /// <summary>
        /// Singleton
        /// </summary>
        public static MediaInActionQuartz Instance => _instance ?? (_instance = new MediaInActionQuartz());

        protected MediaInActionQuartz()
        {
            Init();
        }
