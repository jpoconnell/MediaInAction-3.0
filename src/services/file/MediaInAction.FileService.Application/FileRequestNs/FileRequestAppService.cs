...
public class FileRequestAppService : FileServiceAppService, IFileRequestAppService
{
    ...
    public virtual async Task<FileRequestDto> CreateAsync(FileRequestCreationDto input)
    {
        var fileRequest = new FileRequest(id: GuidGenerator.Create(), operation: input.Operation);
