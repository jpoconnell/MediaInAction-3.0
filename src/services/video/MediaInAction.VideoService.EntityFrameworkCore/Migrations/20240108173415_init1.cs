    ...
    public partial class init1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TraktRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "TraktRequestItem",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Slug = table.Column<string>(type: "text", nullable: true),
                    Season = table.Column<int>(type: "integer", nullable: false),
                    TraktRequestId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TraktRequestItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TraktRequestItem_TraktRequests_TraktRequestId",
                        column: x => x.TraktRequestId,
                        principalTable: "TraktRequests",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TraktRequestItem_TraktRequestId",
                table: "TraktRequestItem",
                column: "TraktRequestId");
        }
