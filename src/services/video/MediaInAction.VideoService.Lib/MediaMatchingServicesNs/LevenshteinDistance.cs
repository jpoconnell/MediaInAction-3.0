...
namespace MediaInAction.VideoService.MediaMatchingServicesNs
{
     ...
     * 
     * Samuel Allen (Dot Net Perls) worked on this particular implementation.
     * It is in the public domain, as I cannot hold copyrights to such a
     * popular algorithm! I might as well patent the IF statement.
     * 
     * Samuel Allen, http://dotnetperls.com, April 2008
     * Posted on Google Code, dotnetperls-controls.
     * 
     * */
