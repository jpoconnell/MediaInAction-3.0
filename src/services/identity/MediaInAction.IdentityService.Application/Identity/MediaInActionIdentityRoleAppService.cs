...
using MediaInAction.IdentityService.BackgroundJobs.Roles;
using Volo.Abp.BackgroundJobs;
using Volo.Abp.DependencyInjection;
using Volo.Abp.Identity;

namespace MediaInAction.IdentityService.Identity;

[ExposeServices(typeof(IdentityRoleAppService), typeof(IIdentityRoleAppService))]
public class MediaInActionIdentityRoleAppService : IdentityRoleAppService
{
    private readonly IBackgroundJobManager _backgroundJobManager;
    private readonly IdentityRoleManager _identityRoleManager;

    public MediaInActionIdentityRoleAppService(IdentityRoleManager roleManager, IIdentityRoleRepository roleRepository,
